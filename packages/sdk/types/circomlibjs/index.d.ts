...
declare module "circomlibjs" {
  // we defines some custom types here, which are not exported from circomlibjs
  ...
  export type PoseidonHash = (inputs: BigInterArray, initState?: BigInter, nOut?: number) => RawFF;
  export type EdDSASig = { R8: Point; S: bigint };

  // types that have been manually examined and modified will be put here.
  export function buildPoseidonReference(): Promise<PoseidonHash>;
  ...
  export class EdDSA {
    ...
    // constructor(babyJub: any, pedersenHash: any, mimc7: any, poseidon: any, mimcSponge: any);

    pruneBuffer(buff: Buffer): Buffer;

    prv2pub(prv: Uint8Array): Point;

    // signPedersen(prv: any, msg: any): { R8: any[]; S: any };

    // signMiMC(prv: any, msg: any): { R8: any[]; S: any };

    // signMiMCSponge(prv: any, msg: any): { R8: any[]; S: any };

    signPoseidon(prv: Uint8Array, msg: RawFF): EdDSASig;

    // verifyPedersen(msg: any, sig: any, A: any[]): boolean;

    // verifyMiMC(msg: any, sig: any, A: any[]): boolean;

    verifyPoseidon(msg: RawFF, sig: EdDSASig, A: Point): boolean;
  ...
  // Generated by dts-gen initially, version "circomlibjs": "^0.1.7"
  export class SMT {
