...
template BodyHasher() {
  signal input val_msb;
  signal input val_lsb;
  signal output out;

  component hasher = Poseidon(2);
  hasher.inputs[0] <== val_msb;
  hasher.inputs[1] <== val_lsb;
  out <== hasher.out;
}
...
template Main() {
  ...
  signal input val_msb;
  signal input val_lsb;
  signal input val_lb_msb;
  signal input val_lb_lsb;
  signal input val_ub_msb;
  signal input val_ub_lsb;
  signal output out_val_lb_msb;
  signal output out_val_lb_lsb;
  signal output out_val_ub_msb;
  signal output out_val_ub_lsb;
  ...
  body_hasher.val_msb <== val_msb;
  body_hasher.val_lsb <== val_lsb;
  ...
  component val_range_check = Scalar256RangeChecker();
  val_range_check.in_msb <== val_msb;
  val_range_check.in_lsb <== val_lsb;
  val_range_check.lower_bound_msb <== val_lb_msb;
  val_range_check.lower_bound_lsb <== val_lb_lsb;
  val_range_check.upper_bound_msb <== val_ub_msb;
  val_range_check.upper_bound_lsb <== val_ub_lsb;
  out_val_lb_msb <== val_lb_msb;
  out_val_lb_lsb <== val_lb_lsb;
  out_val_ub_msb <== val_ub_msb;
  out_val_ub_lsb <== val_ub_lsb;
}
