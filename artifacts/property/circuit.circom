...
template Main() {
  ...
  // defs
  signal input val;
  signal input val_eq_check0;
  signal output out_val_eq0;
  ...
  component val_eq_check = PropertyEqualityChecker(1);
  val_eq_check.in <== val;
  val_eq_check.equals_to[0] <== val_eq_check0;
  out_val_eq0 <== val_eq_check.out[0];
  }
