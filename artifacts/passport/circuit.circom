...
template BodyHasher() {
  ...
  signal input issue_date;
  signal input first_verification_date;
  ...
  hasher.inputs[4] <== issue_date;
  hasher.inputs[5] <== first_verification_date;
  hasher.inputs[6] <== last_selfie_date;
  hasher.inputs[7] <== total_sefie_verified;
  out <== hasher.out;
}
...
template Main() {
  ...
  signal input issue_date_lb;
  signal input issue_date_ub;
  signal input first_verification_date_lb;
  signal input first_verification_date_ub;
  ...
  signal output out_issue_date_lb;
  signal output out_issue_date_ub;
  signal output out_first_verification_date_lb;
  signal output out_first_verification_date_ub;
  ...
  body_hasher.issue_date <== issue_date;
  body_hasher.first_verification_date <== first_verification_date;
  ...
  component issue_date_range_check = ScalarRangeChecker(64);
  issue_date_range_check.in <== issue_date;
  issue_date_range_check.lower_bound <== issue_date_lb;
  issue_date_range_check.upper_bound <== issue_date_ub;
  out_issue_date_lb <== issue_date_lb;
  out_issue_date_ub <== issue_date_ub;

  component first_verification_date_range_check = ScalarRangeChecker(64);
  first_verification_date_range_check.in <== first_verification_date;
  first_verification_date_range_check.lower_bound <== first_verification_date_lb;
  first_verification_date_range_check.upper_bound <== first_verification_date_ub;
  out_first_verification_date_lb <== first_verification_date_lb;
  out_first_verification_date_ub <== first_verification_date_ub;
